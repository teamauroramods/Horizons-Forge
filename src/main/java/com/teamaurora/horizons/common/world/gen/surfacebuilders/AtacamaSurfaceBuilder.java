package com.teamaurora.horizons.common.world.gen.surfacebuilders;
...
public class AtacamaSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {
    private static final Supplier<Block> COBBLED_TERRACOTTA = HorizonsBlocks.COBBLED_TERRACOTTA;
    private static final BlockState ORANGE_TERRACOTTA = Blocks.ORANGE_TERRACOTTA.getDefaultState();
    private static final BlockState TERRACOTTA = Blocks.TERRACOTTA.getDefaultState();
    private static final Supplier<Block> MUDCRACK = HorizonsBlocks.MUDCRACK;
    private static final Supplier<Block> ATACAMA_SAND = HorizonsBlocks.ATACAMA_SAND;
    ...
    public AtacamaSurfaceBuilder(Codec<SurfaceBuilderConfig> p_i232122_1_) {
        super(p_i232122_1_);
    }
            ...
            if (i1 < 15) {
                ...
                if (blockstate4.isAir()) {
                    ...
                    if (l == -1) {
                        ...
                        if (j1 >= seaLevel - 1) {
                            if (j1 > seaLevel + 3 + k && startHeight > seaLevel + 13 + k) {
                            ...
                            if (block == Blocks.WHITE_TERRACOTTA || block == Blocks.ORANGE_TERRACOTTA || block == Blocks.MAGENTA_TERRACOTTA || block == Blocks.LIGHT_BLUE_TERRACOTTA || block == HorizonsBlocks.MUDCRACK.get() || block == Blocks.LIME_TERRACOTTA || block == Blocks.PINK_TERRACOTTA || block == Blocks.GRAY_TERRACOTTA || block == HorizonsBlocks.MUDCRACK.get() || block == Blocks.CYAN_TERRACOTTA || block == Blocks.PURPLE_TERRACOTTA || block == Blocks.BLUE_TERRACOTTA || block == Blocks.BROWN_TERRACOTTA || block == Blocks.GREEN_TERRACOTTA || block == Blocks.RED_TERRACOTTA || block == Blocks.BLACK_TERRACOTTA) {
                                chunkIn.setBlockState(blockpos$mutable, ATACAMA_SAND.get().getDefaultState(), false);
                            }
                        }
                    } else if (l > 0) {
                        --l;
    ...
    protected void func_215430_b(long p_215430_1_) {
        ...
        for(int i = 0; i < i2; ++i) {
            ...
            for(int l = 0; k + l < 64 && l < j; ++l) {
                this.field_215432_a[k + l] = MUDCRACK.get().getDefaultState();
            }
        }
        ...
        for(int k2 = 0; k2 < j2; ++k2) {
            ...
            for(int i1 = 0; l3 + i1 < 64 && i1 < i3; ++i1) {
                this.field_215432_a[l3 + i1] = COBBLED_TERRACOTTA.get().getDefaultState();
            }
        }
        ...
        for(int j3 = 0; j3 < l2; ++j3) {
            ...
            for(int j1 = 0; k4 + j1 < 64 && j1 < i4; ++j1) {
                this.field_215432_a[k4 + j1] = COBBLED_TERRACOTTA.get().getDefaultState();
            }
        }
        ...
        for(int l4 = 0; l4 < k3; ++l4) {
            ...
            for(int k1 = 0; j4 + k1 < 64 && k1 < 1; ++k1) {
                ...
                if (j4 + k1 > 1 && sharedseedrandom.nextBoolean()) {
                    this.field_215432_a[j4 + k1 - 1] = MUDCRACK.get().getDefaultState();
                }
